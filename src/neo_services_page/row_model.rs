...
mod imp {
    ...
    #[derive(Properties)]
    #[properties(wrapper_type = super::ServicesRowModel)]
    pub struct ServicesRowModel {
        ...
        #[property(get, type = ServicesContentType, builder(ServicesContentType::SectionHeader))]
        pub content_type: Cell<ServicesContentType>,
        #[property(get, type = ServicesSectionType, builder(ServicesSectionType::UserServices))]
        pub section_type: Cell<ServicesSectionType>,
    ...
    impl Default for ServicesRowModel {
        fn default() -> Self {
            Self {
                ...
                content_type: Cell::new(ServicesContentType::SectionHeader),
                section_type: Cell::new(ServicesSectionType::UserServices),
                ...
                children: RefCell::new(gio::ListStore::new::<super::ServicesRowModel>()),
            }
        }
    }

    impl ServicesRowModel {
    ...
    impl ObjectSubclass for ServicesRowModel {
        const NAME: &'static str = "ServicesRowModel";
        type Type = super::ServicesRowModel;
    }

    impl ObjectImpl for ServicesRowModel {
...
#[enum_type(name = "ServicesContentType")]
pub enum ServicesContentType {
    SectionHeader,
    Service,
    Process,
}

impl From<ServicesContentType> for String {
    fn from(value: ServicesContentType) -> Self {
        match value {
            ServicesContentType::SectionHeader => i18n("Section Header"),
            ServicesContentType::Service => i18n("Service"),
            ServicesContentType::Process => i18n("Process"),
        }
    }
}

#[derive(Clone, Copy, Debug, Eq, PartialEq, glib::Enum, Ord, PartialOrd)]
#[enum_type(name = "ServicesSectionType")]
pub enum ServicesSectionType {
    UserServices,
    SystemServices,
}

pub struct ServicesRowModelBuilder {
    id: glib::GString,
    ...
    content_type: ServicesContentType,
...
impl ServicesRowModelBuilder {
    ...
    pub fn content_type(mut self, content_type: ServicesContentType) -> Self {
        self.content_type = content_type;
        self
    }

    pub fn section_type(mut self, section_type: ServicesSectionType) -> Self {
    ...
    pub fn build(self) -> ServicesRowModel {
        let this = ServicesRowModel::new(self.content_type);
...
glib::wrapper! {
    pub struct ServicesRowModel(ObjectSubclass<imp::ServicesRowModel>);
}

impl ServicesRowModel {
    pub fn new(content_type: ServicesContentType) -> Self {
